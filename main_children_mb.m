...
tpm='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/LabCode/typical_data_analysis/templates_cerebroMatic/ELP_7_105Template/mw_com_prior_Age_0105.nii'; %This is your template path
addpath(genpath(spm_path));
root='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/PhonReading_7_9'; %This is your project folder
subjects={}; %manually put subject numbers say 'sub-5004' 'sub-5009', or leave this empty if you have an excel with data_info.
data_info='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/PhonReading_7_9/data_bids.xlsx'; %final_sample sheet, the subject column should have sub plus subject number.(e.g. sub-5003)
if isempty(subjects)
...
CCN.preprocessed_folder='preproc_bids'; %This is your data folder needs to be preprocessed
