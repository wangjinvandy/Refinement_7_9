...
data=struct();
root='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/PhonReading_7_9';  %your project path
subjects={};
...
global CCN
CCN.preprocessed='preproc_bids'; % your data folder
...
conditions{3}={'P_O' 'P_R' 'P_SC' 'P_U'};
conditions{4}={'P_O' 'P_R' 'P_SC' 'P_U'};
...
%matched.
contrasts={'onset_vs_perc_T1' 'rhyme_vs_perc_T1' 'onset_vs_perc_T2' 'rhyme_vs_perc_T2' 'onset_vs_perc_T2_vs_T1' 'rhyme_vs_perc_T2_vs_T1'};
...
rp_w=zeros(1,6);
empty=zeros(1,10);
weights={[onset_vs_perc rp_w onset_vs_perc rp_w empty empty]...
    [rhyme_vs_perc rp_w rhyme_vs_perc rp_w empty empty] ...
    [empty empty onset_vs_perc rp_w onset_vs_perc rp_w] ...
    [empty empty rhyme_vs_perc rp_w rhyme_vs_perc rp_w] ...
    [-1*onset_vs_perc rp_w -1*onset_vs_perc rp_w onset_vs_perc rp_w onset_vs_perc rp_w] ...
    [-1*rhyme_vs_perc rp_w -1*rhyme_vs_perc rp_w rhyme_vs_perc rp_w rhyme_vs_perc rp_w]};
